...
## Features
- **Zero Server Costs:** Since it uses native browser APIs, there is no massive file uploading needed. It works incredibly fast completely locally.
...
- **Large Resolution Support:** Harnesses `Canvas.toBlob` to export massive, multi-megabyte 3000px+ barcodes without browser memory crashes.
